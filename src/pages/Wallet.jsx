  ...
  return (
    <div className="page universe-page wallet-universe">
      <section className="wallet-cosmos-hero panel-universe">
        <div><span className="eyebrow"><Sparkles size={15}/> VÍ DOCSHARE</span><h1>Credit, Premium & thanh toán</h1><p>Credit dùng để mua tài liệu và tặng quà. Tất cả giao dịch đều có trạng thái rõ ràng.</p></div>
